                        ...
                        <div className="p-4 grid auto-rows-min gap-4 md:grid-cols-2">
                            <div className="aspect-video rounded-xl bg-muted/50 border">
                                <p className="p-2 flex flex-row justify-center">
                                    Software Developer | Projeto de Desenvolvimento App Educação Financeira - Belo Horizonte/MG
                                </p>
                                <p className="flex flex-row justify-center">Em Progresso</p>

                                <p className="p-2">
                                    O App de Educação Financeira é um projeto de idealização pessoal onde eu estou sendo o
                                ...
                                <p className="p-2">
                                    <span>
                                        Tecnologias: &nbsp;
                                        <strong>
                                            NodeJs, Express, React, Jenkins, Oracle Cloud, Docker, Portainer, Nginx
                                            Proxy Manager
                                        </strong>
                                    </span>
                                </p>
                            ...
                            <div className="aspect-video rounded-xl bg-muted/50 border">
                                ...
                                <p className="flex flex-row justify-center">Julho 2022 - Atualmente</p>
                    ...
                    <div className="min-h-[50vh] flex-1 rounded-xl bg-stone-600 border md:min-h-min">
                        ...
                        <div className="p-4 grid auto-rows-min gap-4 md:grid-cols-2">
                            <div className="aspect-video rounded-xl bg-muted/50 border">
                                ...
                                <p className="flex flex-row justify-center">Março 2022 - Julho 2022</p>
                                <p className="p-2">
                                ...
                                <p className="p-2">Tecnologias: C#, ASP.NET MVC, SQL Server, JavaScript.</p>
                                <ul className="p-2">
                                    <li>
                            ...
                            <div className="aspect-video rounded-xl bg-muted/50 border">
                                ...
                                <p className="flex flex-row justify-center">Setembro 2022 - Atualmente</p>
